...
export const TOOL_HANDLERS: Record<string, ToolHandler> = {
  ...
  capture_micro_profiler: (tools, body) => tools.captureMicroProfiler(body.target, {
    ...
    arm_timeout_ms: body.arm_timeout_ms,
    frames_before: body.frames_before,
    post_trigger_frames: body.post_trigger_frames,
    max_frame_breakdowns: body.max_frame_breakdowns,
